...
function ForgotPassword() {
  ...
  const handleSendOTP = async () => {
    try {
      const response = await axios.post('https://eduvance-backend.onrender.com/send-otp', { email });
  ...
  const handleResetPassword = async () => {
    try {
      const response = await axios.post('https://eduvance-backend.onrender.com/forgotpassword', { email, otp, newPassword });
      if (response.data.success) {
