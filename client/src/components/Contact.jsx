          ...
          <div className="col-md-10">
            <div className="row g-0 rounded">
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, rgba(127, 39, 156, 1) 0%, rgba(46, 39, 157, 1) 110%)",
                }}
              >
                <h3 className="mb-4" style={{ color: "white" }}>
                  Send us a <span style={{ color: "#d62196" }}>message</span>
                </h3>
              ...
              <div
                className="col-md-6 d-flex align-items-stretch p-4"
                style={{ background: "#f1f1f1", borderRadius: "15px" }}
              >
                <div className="info-wrap w-100 ">
                  ...
                  <div className="dbox w-100 d-flex align-items-start mb-3">
                    <div className="text pl-3">
                      <p>
                        <span className="fw-bold">Address:</span> West 21th
                        Street, Suite 721 New Delhi 110001
                      </p>
                    </div>
                  </div>
                  <div className="dbox w-100 d-flex align-items-center mb-3">
                    <div className="text pl-3 ">
                      <p>
                        ...
                        <a
                          href="tel://123456789"
                          style={{ color: "#d62196", textDecoration: "none" }}
                        >
                          +1235 2355 98
                        </a>
                      </p>
